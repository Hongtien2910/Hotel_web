...
/**
 * Servlet implementation class DeleteRequestByOwner
 */
@WebServlet("/DeletRequestByOwner")
public class DeleteRequestByOwner extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteRequestByOwner() {
		super();
