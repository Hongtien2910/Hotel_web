...
/**
 * Servlet implementation class DeleteRequestByUser
 */
@WebServlet("/DeletRequestByUser")
public class DeleteRequestByUser extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DeleteRequestByUser() {
		super();
